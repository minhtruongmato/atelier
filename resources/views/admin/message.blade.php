...
@section('content')
    <div class="content-wrapper">
        <link rel="stylesheet" href="{{ asset ("public/admin/css/message.css") }}">
        ...
        <div id="chatPosition" width="800px" style="position: fixed;right:15px;bottom:15px">
            <div>
                ...
                <script type="text/javascript">
                    ...
                    socket.on("Server-send-list-message-to-room", function(data){
                        $("#conversation").html("");
                        console.log(data);
                        $.each(data, function(key, value){
                            $("#conversation").append(value.author + ": " + value.message + "<br>");
                        });
                    });
