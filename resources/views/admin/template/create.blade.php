        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Thêm mới cấu hình</div>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('template.store') }}" enctype="multipart/form-data" id="config-form">
                            ...
                            <div class="content-config">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control config-validate" name="name" value="{{ old('name') }}" >
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }} remove-config">
                                    <label for="title" class="col-md-2 control-label">Thông Số 1</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control config-validate" name="title[0]" value="{{ old('title') }}" data-child="0">
