            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('kind.update', ['id' => $kind->id]) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div class="col-md-6">
                                    <select name="type"  class="form-control">
                                        ...
                                        @foreach($type as $value)
                                            <option value="{{ $value->id }}" {{ ($value->id == $kind->type_id)? 'selected' : ''}}>{{ $value->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" value="{{ $kind->title }}" autofocus>
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="slug" type="text" class="form-control" name="slug" value="{{ $kind->slug }}"  readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {{ HTML::image('storage/app/kind/'.$kind->image,'', array('width' => 150)) }}
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" rows="10" class="form-control" name="description" value="{{ old('description') }}"  autofocus>{{ $kind->description }}</textarea>
